...
from ..config import DB_CONNECTION, PROCESSED_DIR, RAW_DIR
...
df_operadoras_db = df_operadoras[[
...
df_operadoras_db.to_sql('operadoras', con=engine, if_exists='replace', index=False)
...
df_despesas_db.to_sql('despesas', con=engine, if_exists='replace', index=False, chunksize=1000)
